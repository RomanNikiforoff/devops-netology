...
```shell
nrv@nrv:~/devops-netology/homeworks/08-ansible-03-yandex/playbook$ ansible-lint site.yml
WARNING: PATH altered to include /usr/bin
WARNING  Overriding detected file kind 'yaml' with 'playbook' for given positional argument: site.yml
nrv@nrv:~/devops-netology/homeworks/08-ansible-03-yandex/playbook$
```
...
```shell
nrv@nrv:~/devops-netology/homeworks/08-ansible-03-yandex/playbook$ ansible-playbook -i inventory/prod.yml site.yml --diff
...
--- before
+++ after: /home/nrv/.ansible/tmp/ansible-local-11384fv33osx_/tmpnuu8jav2/vector.service.j2
@@ -0,0 +1,22 @@
+[Unit]
+Description=Vector
...
+++ after: /home/nrv/.ansible/tmp/ansible-local-11384fv33osx_/tmp5_0msmoq/vector.toml.j2
@@ -11,7 +11,7 @@
...
TASK [Add repo nginx] **************************************************************************************************************
--- before
+++ after: /home/nrv/.ansible/tmp/ansible-local-11384fv33osx_/tmpj87oki84/nginx.repo.j2
@@ -0,0 +1,7 @@
+[nginx-stable]
...
+++ after: /home/nrv/.ansible/tmp/ansible-local-11384fv33osx_/tmp6ip81jvw/nginx.conf.j2
@@ -1,44 +1,12 @@
 server {
     listen       80;
...
failed: [clickhouse-01] (item=clickhouse-common-static) => {"ansible_loop_var": "item", "changed": false, "dest": "./clickhouse-common-static-22.3.3.44.rpm", "elapsed": 0, "gid": 1001, "group": "nrv", "item": "clickhouse-common-static", "mode": "0664", "msg": "Request failed", "owner": "nrv", "response": "HTTP Error 404: Not Found", "secontext": "unconfined_u:object_r:user_home_t:s0", "size": 246310036, "state": "file", "status_code": 404, "uid": 1000, "url": "https://packages.clickhouse.com/rpm/stable/clickhouse-common-static-22.3.3.44.noarch.rpm"}
